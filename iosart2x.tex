...
\bibitem[(Lamport, 1985)]{1} Lamport, L. (1985). \textit{\LaTeX{} User's Guide \& Reference Manual}. Addison Wesley Publishing Co.

\bibitem[(Newman and Liu, 1998)]{2} Newman, B. \& Liu, E.T. (1998). Perspective on BRCA1. \textit{Breast Disease}, \textit{10}, 3--10. \bid{doi={10.3233/BD-1998-101-203}}

\bibitem[(Pilkey, 1995)]{3} Pilkey, D.F. (1995). \textit{Happy conservation laws}. In J. Frost (Ed.), \textit{Neural Stresses} (pp. 332--391). Georgia: Controlled Press.

\bibitem[(Wilson, 1991)]{4} Wilson, E. (1991). Active vibration analysis of thin-walled beams. Ph.D. Dissertation, University of Virginia.
