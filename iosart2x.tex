...
\address[A]{Journal Production Department, \institution{IOS Press}, Nieuwe Hemweg 6b, 1013 BG, Amsterdam, \cny{The Netherlands}\printead[presep={\\}]{e1}}
...
\bibitem[(Lamport, 1985)]{1} L. Lamport, \textit{\LaTeX{} User's Guide \& Reference Manual},
 Addison Wesley Publishing Co, 1985.

\bibitem[(Newman and Liu, 1998)]{2} B. Newman and E.T. Liu, Perspective on BRCA1, \textit{Breast Disease} \textbf{10} (1998), 3--10. \bid{doi={10.3233/BD-1998-101-203}}

\bibitem[(Pilkey, 1995)]{3} D.F. Pilkey, \textit{Happy conservation laws}, in: Neural Stresses, J. Frost, ed., Controlled Press, Georgia, 1995, pp. 332--391.

\bibitem[(Wilson, 1991)]{4} E. Wilson, \textit{Active vibration analysis of thin-walled beams}, Ph.D. Dissertation, University of Virginia, 1991.
